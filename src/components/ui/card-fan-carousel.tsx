  ...
  useEffect(() => {
    ...
    cardElements.forEach((card, cardIndex) => {
      ...
      if (slot !== undefined) {
        ...
        gsap.to(card, { x: `${exitX}rem`, opacity: 0, scale: 0.5, rotation: direction === "right" ? -30 : 30, duration: 0.4, ease: "power2.in", zIndex: -1, pointerEvents: "none" });
      } else {
        gsap.set(card, { opacity: 0, scale: 0.3, x: 0, y: 0, zIndex: -1, pointerEvents: "none" });
      }
    });
