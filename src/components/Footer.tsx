...
export function Footer() {
  ...
  return (
    <footer className="grain border-t border-border bg-background pb-10 pt-20">
      <div className="shell grid gap-12 lg:grid-cols-[1.2fr_0.8fr_1fr]">
        <div>
          <Logo />
        ...
        <div>
          <h2 className="label-xs">Contacto</h2>
